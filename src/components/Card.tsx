...
const Card: React.FC<propsCards> = ({
  ...
  const isExpanded = expand
    ? "w-[400px] sm:w-[500px] h-min-[450px] flex-col px-10 gap-8 py-10"
    : "hover:scale-110 w-[300px] h-[270px]";
  ...
  return (
    <div className="flex flex-col items-center gap-8 ">
      <div
        className={` ${isExpanded} flex items-center z-[1] justify-center bg-yellowSecondary rounded-tl-[100px] rounded-br-[100px] transition-all duration-500`}
      >
        <img
          onClick={() => {
            setExpand(!expand);
